...
if (!function_exists('elessi_general_heading')) {
    function elessi_general_heading() {
        ...
        $of_options[] = array(
            ...
            "desc" => __('If you skip this field notification will be default "😁😁 Come back! | ❤️‍🔥❤️‍🔥 Don\'t forget this ...". If you want to add more notifications, you just need to add "|" between notifications.', 'elessi-theme'),
            "std" => "😁😁 Come back! | ❤️‍🔥❤️‍🔥 Don't forget this ...",
            "type" => "text",
