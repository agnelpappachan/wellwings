...
$('body').on('click','.nasa-wrap-review-thumb .nasa-item-review-thumb', function(e) {
    if (! $('body').hasClass('nasa-disable-lightbox-image')) {
        var _this = $(this);
        var _pa = $(_this).parents('.nasa-wrap-review-thumb')
        var _image = $(_pa).find('.nasa-item-review-thumb');
        var items =[];
        var index = $(_image).index(_this);
