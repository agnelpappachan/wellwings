...
$svg_2col = '<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
...
$svg_3col = '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="17" viewBox="0 0 26 17" fill="none">
            <rect width="8" height="8" rx="2" fill="currentColor"/>
            <rect y="9" width="8" height="8" rx="2" fill="currentColor"/>
            <rect x="9" width="8" height="8" rx="2" fill="currentColor"/>
...
$svg_4col = '<svg xmlns="http://www.w3.org/2000/svg" width="23" height="17" viewBox="0 0 23 17" fill="none">
...
$svg_5col = '<svg xmlns="http://www.w3.org/2000/svg" width="29" height="17" viewBox="0 0 29 17" fill="none">
            <rect y="12" width="5" height="5" rx="1" fill="currentColor"/>
            <rect x="6" y="12" width="5" height="5" rx="1" fill="currentColor"/>
            <rect x="12" y="12" width="5" height="5" rx="1" fill="currentColor"/>
            <rect x="18" y="12" width="5" height="5" rx="1" fill="currentColor"/>
...
$svg_6col = '<svg xmlns="http://www.w3.org/2000/svg" width="29" height="17" viewBox="0 0 29 17" fill="none">
...
$svg_list = '<svg xmlns="http://www.w3.org/2000/svg" width="21" height="17" viewBox="0 0 21 17" fill="none">
...
$svg_list2 = '<svg xmlns="http://www.w3.org/2000/svg" width="29" height="17" viewBox="0 0 29 17" fill="none">
